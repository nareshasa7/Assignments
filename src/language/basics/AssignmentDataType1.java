...
public class AssignmentDataType1 {
	...
	public static void main(String[] args) {
		...
		// Step 2: Print the temperature
		System.out.println("Temperature of the city: " + temperature + "°C");
		
		
		//Whether a customer has placed an order: true or false
		boolean hasplacedorder = true;
		
		System.out.println("Has custoner placed an order?" + hasplacedorder);
		
		//Person's phone number: "123-456-7890"
		String phonenumber = "123-456-7890";
		System.out.println("Persons Phone Number" + phonenumber);
	...
	//Person's occupation: "Software Engineer"
		...
		//Person's favourite colour: "Blue"
		 String favouriteColour = "Blue";
	        ...
	        System.out.println("Distance Between Cities: " + distanceBetweenCities + " km");
